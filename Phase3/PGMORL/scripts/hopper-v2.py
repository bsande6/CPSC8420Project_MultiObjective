...
parser.add_argument('--random_mix', default=False, action='store_true')
parser.add_argument('--elite', default=False, action='store_true')
...
test_mix = args.mix
test_random_mix = args.random_mix
test_elite = args.elite
