...
class Population:
    ...
    def elite_prediction_guided_selection(self, args, iteration, ep, opt_graph, scalarization_template):
        ...
        for sample in self.sample_batch:
            ...
            #generate_weights_batch_dfs(0, args.obj_num, args.min_weight, args.max_weight, args.delta_weight, [], test_weights)
        ...
        for _ in range(N):
            ...
            fitness_scores.append(max_metrics)
        ...
        return elite_batch, scalarization_batch, predicted_offspring_objs, fitness_scores
